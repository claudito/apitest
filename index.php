    ...
    <script type="module">
       ...
       import {FirmaPeru} from './lib/firmaperu.js'
        ...
        window.cargarPrevioRutas=function(){
            ...
            document.getElementById("pdf1").value="<?php  echo($_SERVER['HTTP_HOST'] )?>/prueba.pdf";
            document.getElementById("pdf2").value="https://dirisle.nyc3.digitaloceanspaces.com/rendicion/100/5eb62d4dbc3fa18ce5b288f665e8ef84.pdf";
